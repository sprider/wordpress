    ...
    internal class ProcessRequests
    {
        ...
        private static void GetAccessToken(string securityToken)
        {
            try
            {
                ...
                accessTokenRequest.Accept = "*/*";
                accessTokenRequest.Headers.Set(HttpRequestHeader.AcceptLanguage, "en-US");
                accessTokenRequest.ContentType = "application/x-www-form-urlencoded";
                accessTokenRequest.UserAgent = AppSettings.BrowserUserAgent;
                accessTokenRequest.Headers.Set(HttpRequestHeader.AcceptEncoding, "gzip, deflate");
                accessTokenRequest.Host = AppSettings.BrowserHost;
